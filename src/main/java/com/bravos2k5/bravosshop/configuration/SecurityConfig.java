...
import com.bravos2k5.bravosshop.security.filter.CustomAuthenticationFilter;
import com.bravos2k5.bravosshop.security.filter.JwtFilter;
import com.bravos2k5.bravosshop.security.handler.CustomFailureHandler;
import com.bravos2k5.bravosshop.security.handler.CustomSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain security(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        ...
        http.logout(logout -> {
            ...
            logout.deleteCookies("token","JSESSIONID");
